...
class __TwigTemplate_6236715275e94bd2ef639461d4b5f43352f18684209c8210a488a4a419aaab01 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"\">
    ...
    ";
        ...
        <p>";
            // line 13
            echo ((twig_get_attribute($this->env, $this->source, $context["animal"], "missing", [], "any", false, false, false, 13)) ? ("Yes") : ("No"));
            echo "</p>
        <p>";
            // line 14
            echo ((twig_get_attribute($this->env, $this->source, $context["animal"], "found", [], "any", false, false, false, 14)) ? ("Yes") : ("No"));
            echo "</p>
        <p>";
            // line 15
        ...
        <p>";
            // line 16
            ((twig_get_attribute($this->env, $this->source, $context["animal"], "date", [], "any", false, false, false, 16)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["animal"], "date", [], "any", false, false, false, 16), "Y-m-d"), "html", null, true))) : (print ("")));
            echo "</p>
...
";
    ...
    {
        return array (  123 => 19,  114 => 16,  110 => 15,  106 => 14,  102 => 13,  99 => 12,  95 => 11,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"\">
    ...
    {% for animal in animals %}
        ...
        <p>{{ animal.missing ? 'Yes' : 'No' }}</p>
        <p>{{ animal.found ? 'Yes' : 'No' }}</p>
        <p>{{ animal.name }}</p>
        <p>{{ animal.date ? animal.date|date('Y-m-d') : '' }}</p>
